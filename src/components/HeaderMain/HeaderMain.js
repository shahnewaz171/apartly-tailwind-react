        ...
        <div className="bg-white h-screen flex flex-col justify-center items-center headerImage">
            <div className="bg-auto bg-no-repeat bg-center ..." >
                ...
                <form onSubmit={handleSubmit} className="flex justify-center">
                    <input className="bg-gray-200 hover:bg-white hover:border-gray-300 focus:outline-none focus:bg-white focus:shadow-outline focus:border-gray-300 py-2 px-4 rounded w-3/5" placeholder="Search..." required />
